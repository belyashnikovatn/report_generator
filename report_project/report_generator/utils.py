...
def generate_docx_report(data, total):
    ...
    doc.add_heading('1.6.1.1. Автомобильные дороги федерального, регионального и межмуниципального значения', level=2)
    ...
    doc.add_paragraph('Таблица 1.6.1.1.1 Дороги общего пользования регионального и межмуниципального значения:')
